		...
		<div class="well">
				<div class="row">
					<div class="col-md-8">
						...
						<form class="form-horizontal" method="post" onSubmit="return validateRegistration()" action="./process_form.php">
			...
			<footer>
				<div class="row">
					...
					<p class="text-center col-md-12"><small>© Copyright Joshitha Velkur, Srinu Gopathi. All rights reserved.</small></p>
				</div>
			</footer>
		</div>
	</div>
